...
此文为好奇心课程编程方向的第二节课的部分内容。实时课程内容可点击原文链接访问 Github@lzwjava。有错别字或对内容有疑问可留言评论或到GitHub评论。第二节课想教授学生使用和熟悉某一门编程语言。第2节课当前有如下内容，熟悉编程环境、试用Rust编程、试用Python编程、试用C编程、使用Java编程。可在今天的公众号推送1条、2条等处找到。
