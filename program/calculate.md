...
当问一个刚出生的幼儿，`2+5`等于多少的时候。他是不知道的。他完全不知道这什么意思。在这之前，是教小孩子认数字。我们说2根指头就是2，5根指头就是5。2只猫也是2，5只猫是5。这意味着什么。我们在教会孩子数字这个概念。当学习另外一种语言的时候，就体会很深刻了。`あ`是什么？你知道吗。还没学习日语的时候，就不知道。这个字有点像`女`字，是`女`字的弯曲版本。
