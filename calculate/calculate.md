...
* 阅读完毕此文后，可以将[王垠的文章](http://www.yinwang.org/blog-cn/2018/04/13/computer-science)过一遍。原文更详细一些。
* 构想一些算术表达式和场景，用Keynote、PowerPoint或流程图工具，画出相应的计算图。如本文上面的例子。本文有10张计算图。学生需要换个算术和场景，来把计算图都画一遍。
* 作业提交形式为一篇图文形式的文档，有10个小节。每个小节一段文字描述算术表达式或场景，一张图片表达相应的计算图。
